...
loadNgrams(ngramsData)
//await loadNgrams('ngramsM60.js')
//console.log(ngramsData.ngrams[' L_>L'])
...
function detect (text) {
  ...
  //console.log("byteWords", byteWords)
  const byteNgrams = getByteNgrams(byteWords)
  //console.log("byteNgrams", byteNgrams)
  const numNgrams = Object.keys(byteNgrams).length
  //console.log("numNgrams", numNgrams)
